...
const NavBar = () => {
    ...
    return(
        ...
        <div className='fixed px-4 top-0 left-0 h-full flex flex-col bg-black w-[225px] rounded-br-md z-10'>
            <button /* spotify profile image */ className='mb-2 mt-6 cursor-pointer'>
                {session.user.image ? (
            ...
            <div /*sidenav buttons */ className={`${isProfile ? 'flex flex-col' : 'flex flex-col'}`}>
                <ul className="flex flex-col border-t border-white-1">
                    <button className='flex w-full text-left justify-between hover:bg-green-600 transition duration-300 ease-in-out sideNav-link'
                    ...
                    <Link href='/profile'>
                        ...
                        <div className='flex w-full text-left justify-between hover:bg-green-600 transition duration-300 ease-in-out sideNav-link'>
                        Profile
                            <div className="transparent">
                    ...
                    className='flex justify-between bg-red-600 w-full text-left hover:bg-gray-600 transition duration-300 ease-in-out sideNav-link'>
                    Log Out
                        <div className="transparent">
